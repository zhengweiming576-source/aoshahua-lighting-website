-- Two refinements to the inquiry mailer:
--   * recipient_email may now hold several addresses separated by commas, so
--     the alert can land in more than one inbox;
--   * when the same secret name has been stored more than once, always use the
--     newest one instead of an arbitrary row.
-- Applied: 2026-09-10
